...
// Right chevron — opens a settings/mapping side panel (14×14).
...
// Overlapping pages — the copy-to-clipboard button's idle glyph (13×13).
...
// Checkmark — the copy-to-clipboard button's "copied!" confirmation (13×13).
...
// Close (✕) — side-panel close button (13×13).
